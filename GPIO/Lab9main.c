...
//Globals
unsigned long Led;
unsigned long SW1; //PF4
unsigned long SW2; //PF0
...
int main(void){  unsigned long i,last,now;
  ...
  while(1){
    Led = GPIO_PORTF_DATA_R;      // read previous
		SW1 = GPIO_PORTF_DATA_R&0x10; //read PF4 to SW1
		SW2 = GPIO_PORTF_DATA_R&0x01; //read PF0 to SW2
		if(SW1 != 0x10 || SW2 != 0x01 || (SW1 != 0x10 && SW2 != 0x01)){
	...
	if(SW1 != 0x10 || SW2 != 0x01 || (SW1 != 0x10 && SW2 != 0x01) || Led == 0x02){	
    if(i<50){
